...
<!-- end banner_x -->
	...
	<div class="xiangqing">
		<div class="neirong w">
			...
			<div class="xiaomi6 fl"><%=request.getParameter("goodname") %></div>
	...
	<div class="jieshao mt20 w">
		<div class="left fl"><img src="<%=request.getParameter("goodpic1")%>"><input type="hidden" name="goodpic" value="<%=request.getParameter("goodpic") %>"></div>
		<div class="right fr">
			...
			<div class="xqxq mt20 ml20">
				<div class="top1 mt10">
					<div class="left1 fl"><%=request.getParameter("goodname") %></div>
