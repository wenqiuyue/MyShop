...
<body>
<%List<Order> li=(List<Order>)session.getAttribute("queryList"); %>
<header>
...
<!-- self_info -->
	<div class="grzxbj">
		...
		<div class="rtcont fr">
			...
			<div class="ddxq">
				<div class="ddspt fl"><img src="<%=o.getPic() %>" width="80" height="80"></div>
				<div class="ddbh fl"><%=o.getName() %></div>
				<div class="ztxx fr">
					<ul>
						<li>待发货</li>
						<li>￥<%=o.getPrice() %></li>
						<li><a href="DeleteDingDanServlet?id=<%=o.getId()%>&&userid=<%=o.getUserid()%>">取消订单</a></li>
